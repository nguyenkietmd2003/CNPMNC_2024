...
export default function initModels(sequelize) {
  ...
  //
  Category.hasMany(Category_Product, {
    as: "Category_Products",
    foreignKey: "id_category",
  });
  Category.belongsTo(TagCategory, {
  ...
  //
  VerificationCodes.belongsTo(User, {
    as: "id_user_User",
    foreignKey: "id_user",
  });
  //
  ...
  User.hasMany(VerificationCodes, {
  ...
  ProductReview.belongsTo(UserReview, {
    as: "id_userReview_UserReview",
    foreignKey: "id_userReview",
  });
  //
  UserReview.hasMany(ProductReview, {
    as: "ProductReviews",
    foreignKey: "id_userReview",
  });
  return {
